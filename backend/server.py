...
async def download_source_public(token: str = ""):
    """Genel indirme — sadece doğru token ile.
    Tek seferlik link için kullanılır."""
    # Basit token kontrolü (zaman bazlı)
    expected = "ys2026dnldYS"  # Sabit token, link tek seferlik gibi davransın
    if token != expected:
